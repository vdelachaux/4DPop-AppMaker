...
Class constructor($full : Boolean)
	...
	If (This:C1470.isRemote)
		...
		This:C1470.isModifiable:=False:C215
		This:C1470.isModifiable:=Try(Not:C34(This:C1470.databaseFolder.file(This:C1470.name+".4DZ").exists))
...
Function deleteGeometry()
	...
	// === === === === === === === === === === === === === === === === === === === === === === === === === ===
shared Function compile($options : Object) : Boolean
