...
shared singleton Class constructor()
	...
	$o:={\
		...
		release: Formula from string:C1601("0x"+Substring:C12(This:C1470._version; 3; 1)).call(); \
		...
		Case of 
			...
			: ($type="version")  // Marketing + minor or release + build
				...
				If ($o.release=0)
					...
					return This:C1470._getInfos("short-version")+" build "+String:C10($o.build)+" LTS"
					
				Else 
					
					return This:C1470._getInfos("short-version")+" build "+String:C10($o.build)
			...
			: ($type="long-version")
				...
				Case of 
					...
					: ($o.isBeta)
						...
						return This:C1470._getInfos("version")+" (beta "+String:C10(Num:C11($o.internal))+")"
						
						//………………………………………………………
					: ($o.isAlpha)
						
						return This:C1470._getInfos("version")+" (A"+String:C10(Num:C11($o.internal))+")"
			...
			: ($type="short-version")  // Marketing + minor or release
				...
				If ($o.release=0)
					...
					return This:C1470._getInfos("product")+($o.revision#"0" ? "."+String:C10($o.revision) : "")+" LTS"
					
				Else 
					
					return This:C1470._getInfos("product")+" R"+String:C10($o.release)
...
*/
				...
				Else 
					...
					return Replace string:C233(This:C1470._getInfos("major")+"R"+String:C10(String:C10($o.release)); " "; "")
			...
			: ($type="branch")
				...
				Else 
					...
					return String:C10($o.major)+"R"+String:C10(String:C10($o.release))
