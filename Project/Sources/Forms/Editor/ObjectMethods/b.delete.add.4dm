var $Lon_count; $Lon_x : Integer
var $Ptr_array : Pointer
var $Mnu_choice; $Mnu_main; $Txt_buffer; $Txt_path : Text

$Ptr_array:=OBJECT Get pointer:C1124(Object named:K67:5; "list.delete.items")

$Mnu_main:=Create menu:C408

APPEND MENU ITEM:C411($Mnu_main; Localized string:C991("File…"))
SET MENU ITEM PARAMETER:C1004($Mnu_main; -1; "file")

APPEND MENU ITEM:C411($Mnu_main; Localized string:C991("Folder…"))
...
Case of 
	...
	: ($Mnu_choice="file")
		...
		$Txt_buffer:=Select document:C905(200; "*"; ""; Package open:K24:8+Allow alias files:K24:10+Use sheet window:K24:11)
