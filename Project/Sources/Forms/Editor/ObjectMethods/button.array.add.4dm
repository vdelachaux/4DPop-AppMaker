...
var $Lon_count : Integer
var $Ptr_column_1 : Pointer
var $Txt_buffer; $Txt_path; $Txt_type : Text

GET LIST ITEM PARAMETER:C985(Form:C1466.buildApp; *; "arraytype"; $Txt_type)

If ($Txt_type="path.folder")
	
	$Txt_path:=Select folder:C670(Localized string:C991("selectFolder"); 1)
	
Else 
	
	$Txt_buffer:=Select document:C905(1; \
		Replace string:C233($Txt_type; "path.file"; ""); \
		Localized string:C991("selectFile"); \
