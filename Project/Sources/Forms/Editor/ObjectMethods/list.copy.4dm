  // ----------------------------------------------------
  // Object method : Editor.list.copy - (4DPop AppMaker.4DB)
...
Case of 
	...
	: (Form event:C388=On Selection Change:K2:29)
		  ...
		  //OBJECT SET ENABLED(*;"b.copy.delete";(OBJECT Get pointer(Object named;"list.copy.items"))->>0)
	...
	: (Form event:C388=On Mouse Enter:K2:33)
		...
		(OBJECT Get pointer:C1124(Object named:K67:5;"tips"))->:=Get localized string:C991("tips.copy")
