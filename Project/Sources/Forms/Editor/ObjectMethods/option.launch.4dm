...
Case of 
	...
	: (Form event:C388=On Clicked:K2:4)
		...
		Storage:C1525.preferences.set("options@launch";Choose:C955(Form:C1466.options.launch;"true";"false"))
		
		  //______________________________________________________
	: (Form event:C388=On Mouse Enter:K2:33)
		
		(OBJECT Get pointer:C1124(Object named:K67:5;"tips"))->:=Get localized string:C991("tips.LaunchCompiledDatabase")
