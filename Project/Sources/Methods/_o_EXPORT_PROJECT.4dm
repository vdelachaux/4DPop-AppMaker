...
_o_doc_EMPTY_FOLDER($Obj_params.directory; New collection:C1472(".git"; ".gitattributes"; ".DS_Store"))
		...
		If ($Boo_git)
			...
			If (OK=1)
				...
				If ($o.exists)
					...
					$Lon_bundleVersion:=Num:C11(_o_pList($o.platformPath).get("CFBundleVersion").value)
