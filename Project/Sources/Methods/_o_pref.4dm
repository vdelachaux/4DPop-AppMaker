...
If (False:C215)
	C_OBJECT:C1216(_o_pref; $0)
	C_TEXT:C284(_o_pref; $1)
	C_OBJECT:C1216(_o_pref; $2)
End if 
...
If (This:C1470._is=Null:C1517)
	...
	$o:=New object:C1471(\
		...
		"open"; Formula:C1597(_o_pref("open")); \
		"close"; Formula:C1597(_o_pref("close")); \
		"get"; Formula:C1597(_o_pref("get"; New object:C1471("path"; $1; "type"; $2)).value); \
		"set"; Formula:C1597(_o_pref("set"; New object:C1471("path"; $1; "value"; $2))); \
		"save"; Formula:C1597(_o_pref("save"; New object:C1471("keep"; Bool:C1537($1))))\
		)
