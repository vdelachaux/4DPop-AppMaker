...
If (This:C1470=Null:C1517)
	...
	Use ($o)
		...
		$o.isProject:=(Get database parameter:C643(Is host database a project:K37:99)=1)
		$o.isDatabase:=Not:C34($o.isProject)
		$o.isNewArchitecture:=Num:C11(Application version:C493)>=1800
		...
		$o.settings:=$o.root.folder(Choose:C955($o.isNewArchitecture; "Settings"; "Preferences"))
		$o.preferences:=$o.root.folder("Preferences")
