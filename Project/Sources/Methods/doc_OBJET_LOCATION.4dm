...
$Lon_formEvent:=Choose:C955($Lon_formEvent=0;Form event:C388;$Lon_formEvent)
...
Case of 
	...
	: ($Lon_formEvent=On Load:K2:1)
		...
		If ($Lon_Size>0)
			...
			$Txt_Volume:=Replace string:C233(doc_getVolumeName ($Txt_FullPath);Folder separator:K24:12;"")
