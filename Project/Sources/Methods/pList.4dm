...
If (This:C1470=Null:C1517)
	...
	$o:=New shared object:C1526("file";File:C1566($1;fk platform path:K87:2);\
		"content";Null:C1517;\
		"get";Formula:C1597(pList ("get";Choose:C955(Value type:C1509($1)=Is object:K8:27;$1;New object:C1471("key";$1))));\
		"set";Formula:C1597(pList ("set";$1));\
		"save";Formula:C1597(pList ("save")))
